...
pdf = getObjectFromGUID('f9f1e2')
state = state + 1
if state == 1 then
tokenBagW = bag.takeObject({guid='3569db', position = {-72.72, -0.07, 30.16}})
tokenBagB = bag.takeObject({guid='5d2870', position = {-72.72, -0.07, 32.60}})
...
Objective1B = bag.takeObject({guid='2b655f', position = {-68.95, -0.03, 27.20}, rotation={0, 90, 0}})
Objective2B = bag.takeObject({guid='854cde', position = {-66.46, -0.03, 27.20}, rotation={0, 90, 0}})
Objective3B = bag.takeObject({guid='310aca', position = {-64.26, -0.03, 27.20}, rotation={0, 90, 0}})
Objective4B = bag.takeObject({guid='4905a6', position = {-61.99, -0.03, 27.20}, rotation={0, 90, 0}})
Objective5B = bag.takeObject({guid='d607fe', position = {-59.70, -0.03, 27.20}, rotation={0, 90, 0}})

ObjectiveC1B = bag.takeObject({guid='358a2f', position = {-68.95, -0.05, 28.07}})
ObjectiveC2B = bag.takeObject({guid='8ad27c', position = {-66.46, -0.05, 28.07}})
ObjectiveC3B = bag.takeObject({guid='ed5d2e', position = {-64.26, -0.05, 28.07}})
ObjectiveC4B = bag.takeObject({guid='4c9e84', position = {-61.99, -0.05, 28.07}})
ObjectiveC5B = bag.takeObject({guid='95594e', position = {-59.70, -0.05, 28.07}})

Objective1W = bag.takeObject({guid='f75629', position = {-68.95, -0.05, 23.30}, rotation={0, 90, 0}})
Objective2W = bag.takeObject({guid='a2a872', position = {-66.56, -0.05, 23.30}, rotation={0, 90, 0}})
Objective3W = bag.takeObject({guid='58cb6b', position = {-64.26, -0.05, 23.30}, rotation={0, 90, 0}})
Objective4W = bag.takeObject({guid='3a8398', position = {-61.99, -0.05, 23.30}, rotation={0, 90, 0}})
Objective5W = bag.takeObject({guid='681b22', position = {-59.70, -0.05, 23.30}, rotation={0, 90, 0}})
...
if state == 2 then
a = getObjectFromGUID('3569db') bag.putObject(a)
a = getObjectFromGUID('5d2870') bag.putObject(a)
...
a = getObjectFromGUID('2b655f') bag.putObject(a)
a = getObjectFromGUID('854cde') bag.putObject(a)
a = getObjectFromGUID('310aca') bag.putObject(a)
a = getObjectFromGUID('4905a6') bag.putObject(a)
a = getObjectFromGUID('d607fe') bag.putObject(a)
...
a = getObjectFromGUID('f75629') bag.putObject(a)
a = getObjectFromGUID('a2a872') bag.putObject(a)
a = getObjectFromGUID('58cb6b') bag.putObject(a)
a = getObjectFromGUID('3a8398') bag.putObject(a)
a = getObjectFromGUID('681b22') bag.putObject(a)
